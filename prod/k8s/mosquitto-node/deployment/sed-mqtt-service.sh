...
printf "\nsed-mqtt-service app: $app" 
printf "\nsed-mqtt-service node: $node" 
printf "\nsed-mqtt-service node_port: $node_port" 
printf "\nsed-mqtt-service target_port: $target_port" 
printf "\nsed-mqtt-service target_port_name: $target_port_name" 
