...
printf "\nsed-mongodb-service app: $app" 
printf "\nsed-mongodb-service node: $node" 
printf "\nsed-mongodb-service node_port: $node_port" 
printf "\nsed-mongodb-service target_port: $target_port" 
printf "\nsed-mongodb-service target_port_name: $target_port_name" 
